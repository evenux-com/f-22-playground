...
import { F22FormControlDirective } from '../../directives/form-control.directive';

@Component({
  standalone: true,
  selector: 'f-22-select',
  templateUrl: './select.component.html',
  styleUrls: ['./select.component.scss'],
  imports: [OverlayModule, FormsModule, ReactiveFormsModule, F22FormControlDirective],
  providers: [
    {
